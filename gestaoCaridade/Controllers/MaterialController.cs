...
namespace gestaoCaridade.Controllers
{
    public class MaterialController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDMaterial,Tipo,Valor,DataAquisicao")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDMaterial,Tipo,Valor,DataAquisicao")] Material material)
        {
