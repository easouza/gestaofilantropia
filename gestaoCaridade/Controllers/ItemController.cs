...
namespace gestaoCaridade.Controllers
{
    ...
    public class ItemController : Controller
    {
        ...
        public ItemController(gestaoCaridadeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdItem,Tipo,Valor,DataAquisicao")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdItem,Tipo,Valor,DataAquisicao")] Item item)
        {
            if (id != item.IdItem)
            {
                return NotFound();
